                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone_num" id="" class="form-control" value="{{$item->phone_num}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label >Address</label>
                                            <textarea class="form-control" id="editor" name="address" rows="3" value="{{$item->address}}"></textarea>
                                            </div>
                                    </div>
